...
- eval_metric:
A string that denotes the evaluation metric used for model training and optimization. In the provided configuration, "rmse" stands for Root Mean Squared Error, a typical metric for regression tasks.
- algorithms:
